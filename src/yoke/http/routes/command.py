...
COMMANDS = (
    ...
    CommandInfo(
        name="new", description="Create a new session.", action="session.create"
    ),
    CommandInfo(
        name="pin",
    ...
    CommandInfo(
        name="info",
        description="Inspect current session metadata.",
        action="session.get",
    ),
    CommandInfo(
        name="fork", description="Fork the current session.", action="session.fork"
    ),
    CommandInfo(
        name="title",
    ...
    CommandInfo(
        ...
        description="Generate a new title from the current conversation.",
        action="session.title.regenerate",
    ),
    CommandInfo(
        name="tree",
        description="Inspect or navigate the session tree.",
        action="session.tree",
    ),
    CommandInfo(
        name="model",
    ...
    CommandInfo(
        name="tools",
        description="Inspect or change session tool enablement.",
        action="session.tool",
    ),
    CommandInfo(
        name="mcp",
        description="Inspect or change MCP session policy.",
        action="session.mcp",
    ),
    CommandInfo(
        name="queue",
        description="Inspect or edit pending prompts.",
        action="session.queue",
    ),
    CommandInfo(
        name="ps",
        description="Inspect managed command processes.",
        action="process.list",
    ),
    CommandInfo(
