"""Reconstruct persisted tool traces and merge them with live runtime state."""
...
def merge_trace_entries(
    ...
    """Merge persisted and live trace entries without duplicating call ids."""
...
def _message_context(*, user_text: str | None) -> list[ToolTraceContext] | None:
    context = []
    if user_text:
